...
NINFAS2023_hora_contaminantes <- ggplot(promedio_hora, aes(x = Hora, y = Promedio_Concentracion, color = Contaminante, group = Contaminante)) +
  geom_line(size = 1) +
  facet_wrap(~ Contaminante, scales = "free_y") +
  labs(title = "Promedio de concentración de contaminantes por hora en Puebla NINFAS 2024",
       x = "Hora del día",
       y = "Promedio de concentración") +
  theme_minimal()

# Guardar el gráfico en la carpeta 'imagenes'
ggsave("~/Desktop/UNIVERSITY/Servicio-Social/Data-Mining/SeriesTiempo-contaminantes/imagenes/NINFAS2024/Todos-Contaminantes/NINFAS2024_hora_contaminantes.jpg", NINFAS2023_hora_contaminantes, width = 10, height = 6, dpi = 300)
...
# Ruta base para guardar los gráficos
ruta_base <- "~/Desktop/UNIVERSITY/Servicio-Social/Data-Mining/SeriesTiempo-contaminantes/imagenes/NINFAS2024/Cada-Contaminantes"
...
for(contaminante in contaminantes_unicos) {
  ...
  grafico <- ggplot(datos_contaminante, aes(x = Hora, y = Promedio_Concentracion)) +
    geom_line(size = 1) +
    scale_x_continuous(breaks = 0:23, limits = c(0, 23)) + # Asegura que se muestren todas las horas
    labs(title = paste("Promedio de concentración de", contaminante, "por hora en Puebla NINFAS 2024"),
         x = "Hora del día",
         y = "Promedio de concentración") +
    theme_minimal()
  
  # Definir el nombre del archivo basado en el contaminante
  nombre_archivo <- paste(ruta_base, "/NINFAS2024_hora_", tolower(gsub(" ", "_", contaminante)), ".jpg", sep = "")
...
# Cargamos Datos de ----------------UTP-2023-------------------------------------------------------------
data <- read_csv("~/Desktop/UNIVERSITY/Servicio-Social/Data-Mining/Datos/UTP/UTP-2023-limpiado.csv")
View(data)
...
NINFAS2023_hora_contaminantes <- ggplot(promedio_hora, aes(x = Hora, y = Promedio_Concentracion, color = Contaminante, group = Contaminante)) +
  geom_line(size = 1) +
  facet_wrap(~ Contaminante, scales = "free_y") +
  labs(title = "Promedio de concentración de contaminantes por hora en Puebla UTP 2023",
       x = "Hora del día",
       y = "Promedio de concentración") +
  theme_minimal()

# Guardar el gráfico en la carpeta 'imagenes'
ggsave("~/Desktop/UNIVERSITY/Servicio-Social/Data-Mining/SeriesTiempo-contaminantes/imagenes/UTP2023/Todos-Contaminantes/UTP2023_hora_contaminantes.jpg", NINFAS2023_hora_contaminantes, width = 10, height = 6, dpi = 300)
...
# Ruta base para guardar los gráficos
ruta_base <- "~/Desktop/UNIVERSITY/Servicio-Social/Data-Mining/SeriesTiempo-contaminantes/imagenes/UTP2023/Cada-Contaminantes"
...
for(contaminante in contaminantes_unicos) {
  ...
  grafico <- ggplot(datos_contaminante, aes(x = Hora, y = Promedio_Concentracion)) +
    geom_line(size = 1) +
    scale_x_continuous(breaks = 0:23, limits = c(0, 23)) + # Asegura que se muestren todas las horas
    labs(title = paste("Promedio de concentración de", contaminante, "por hora en Puebla UTP 2023"),
         x = "Hora del día",
         y = "Promedio de concentración") +
    theme_minimal()
  
  # Definir el nombre del archivo basado en el contaminante
  nombre_archivo <- paste(ruta_base, "/UTP2023_hora_", tolower(gsub(" ", "_", contaminante)), ".jpg", sep = "")
