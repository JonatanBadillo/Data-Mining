...
server <- function(input, output, session) {
  ...
  output$map <- renderLeaflet({
    ...
    leaflet() %>%
      addTiles() %>%
      setView(lng = -98.2100, lat = 19.0450, zoom = 17) %>%
      addCircles(
      ...
      addCircleMarkers(lng = puntos_O3$lng, lat = puntos_O3$lat, color = "green", radius = 0.5, fillOpacity = 0.05, popup = "O3") %>%
      addCircleMarkers(lng = puntos_NO2$lng, lat = puntos_NO2$lat, color = "yellow", radius = 0.5, fillOpacity = 0.05, popup = "NO2") %>%
      addCircleMarkers(lng = puntos_CO$lng, lat = puntos_CO$lat, color = "blue", radius = 0.5, fillOpacity = 0.05, popup = "CO") %>%
      addCircleMarkers(lng = puntos_SO2$lng, lat = puntos_SO2$lat, color = "purple", radius = 0.5, fillOpacity = 0.05, popup = "SO2") %>%
      addCircleMarkers(lng = puntos_PM10$lng, lat = puntos_PM10$lat, color = "orange", radius = 0.5, fillOpacity = 0.5, popup = "PM-10") %>%
      addCircleMarkers(lng = puntos_PM25$lng, lat = puntos_PM25$lat, color = "red", radius = 0.5, fillOpacity = 0.05, popup = "PM-2.5")
  })
}
